...
const About = () => {
  ...
  const aboutImages = [
    ...
    '/src/assets/aboutusred.png',
    '/src/assets/aboutusgreen.png',
    '/src/assets/aboutusgrey.png',
    '/src/assets/aboutusyellow.png',
    '/src/assets/aboutusorange.png',
    '/src/assets/aboutuscoffie.png'
  ...
  const features = [
    {
      ...
      description: "We carefully curate our beverage collection to bring you the finest drinks from around the world."
    },
    {
      icon: <Verified sx={{ fontSize: 40 }}/>,
      title: "Quality Guaranteed",
      description: "Every product in our store meets strict quality standards and freshness requirements."
    },
    {
      icon: <LocalShipping sx={{ fontSize: 40 }}/>,
      title: "Fast Delivery",
      description: "We ensure quick and safe delivery of your favorite beverages right to your doorstep."
    },
    {
      icon: <Support sx={{ fontSize: 40 }}/>,
      title: "24/7 Support",
      description: "Our dedicated customer service team is always ready to assist you with any queries."
    }
  ];
  ...
  return (
    <Container className="pt-0 pb-5">
      <Row className="mb-5 align-items-center">
        ...
        <Col md={4}>
          <div 
            className="about-image rounded mx-auto position-relative"
            style={{
              height: '400px',
              width: '300px',
              marginBottom: '20px',
      ...
      <Row className="text-center">
        <Col md={3} className="mb-4 mb-md-0">
          <h2 className="text-primary mb-2">1000+</h2>
          <p className="text-white">Products</p>
        </Col>
        <Col md={3} className="mb-4 mb-md-0">
          <h2 className="text-primary mb-2">5000+</h2>
        ...
        <Col md={3}>
          <h2 className="text-primary mb-2">24/7</h2>
